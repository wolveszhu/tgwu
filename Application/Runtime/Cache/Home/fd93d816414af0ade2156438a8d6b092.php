...
<div class="container">
    <div class="row">
        <div class="col-xs-3 ret"><a href="<?php echo U('Index/index');?>" class="morePro"><img src="/wxmsg/Public/Image/ret.png" class="retIcon"></a></div>
    ...
    <div class="row">
        <div class="col-xs-4 newpro">
            <a href="#">
                <img src="/wxmsg/Public/Home/Image/maoxiong.png" class="proImg" alt="坚果">
            </a>
            <div class="desc">抹茶味正宗山货薯条500g/袋</div>
            <div class="shoucang">
                <div class="row">
                    <div class="col-xs-3"><img src="/wxmsg/Public/Image/shoucang.png" class="scPto"></div>
        ...
        <div class="col-xs-4 newpro">
            <a href="#">
                <img src="/wxmsg/Public/Home/Image/paopaoji.png" class="proImg" alt="卤食">
            </a>
        ...
        <div class="col-xs-4 newpro">
            <a href="#">
                <img src="/wxmsg/Public/Home/Image/bianxing.png" class="proImg" alt="玩具">
            </a>
        ...
        <div class="col-xs-4 newpro">
            <a href="#">
                <img src="/wxmsg/Public/Home/Image/gongzai.png" class="proImg" alt="糖果">
            </a>
        ...
        <div class="col-xs-4 newpro">
            <a href="#">
                <img src="/wxmsg/Public/Home/Image/feixia.png" class="proImg" alt="卤食">
            </a>
            <div class="desc">卤食类</div>
            <div class="shoucang">
                <div class="row">
        ...
        <div class="col-xs-4 newpro">
            <a href="#">
                <img src="/wxmsg/Public/Home/Image/baozhen.png" class="proImg" alt="饮料">
            </a>
