        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i>  <a href="#">邀请码管理</a>
                        </li>
                        <li class="active">
                        ...
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <?php if(is_array($invitations)): $i = 0; $__LIST__ = $invitations;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$invitation): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" attr-id="" id="singcms-delete"  attr-a="carousel" attr-message="删除"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a>
                                        </td>
